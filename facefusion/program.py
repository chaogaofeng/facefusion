...
def create_program() -> ArgumentParser:
	...
	# general
	sub_program.add_parser('api', help = wording.get('help.api'), parents = [ collect_step_program(), create_uis_program(), collect_job_program() ], formatter_class = create_help_formatter_large)
